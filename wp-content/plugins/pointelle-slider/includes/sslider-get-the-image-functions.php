...
function pointelle_sslider_display_the_image( $args = array(), $image = false ) {
	...
	if ( $link_to_post ) {
		$html = '<a class="pointelle_thumb_anchor" href="' . get_permalink( $post_id ) . '" title="' . esc_attr( apply_filters( 'the_title', get_post_field( 'post_title', $post_id ) ) ) . '" '.$a_attr.'>' . $html . '</a>';}
	else {
	    if($permalink!='') {
	      $html = '<a class="pointelle_thumb_anchor" href="' . $permalink . '" title="' . esc_attr( apply_filters( 'the_title', get_post_field( 'post_title', $post_id ) ) ) . '" '.$a_attr.'>' . $html . '</a>';
		}
	}
