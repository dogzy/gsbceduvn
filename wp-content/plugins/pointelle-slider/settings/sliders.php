...
if ($_POST['rename_slider'] == __('Rename','pointelle-slider')) {
...
<form action="" method="post"> 
	<table class="form-table">
		<tr valign="top">
		<th scope="row"><h3><?php _e('Rename Slider to','pointelle-slider'); ?></h3></th>
		<td><h3><input type="text" name="rename_slider_to" class="regular-text" value="<?php echo $slider['slider_name'];?>" /></h3></td>
		</tr>
	</table>
	<input type="hidden" name="current_slider_id" value="<?php echo $slider_id;?>" />
	<input type="submit" value="<?php _e('Rename','pointelle-slider'); ?>"  name="<?php _e('rename_slider','pointelle-slider'); ?>" />
</form>
...
<h2 style="text-align:left;margin:0 0 10px 0">Recommendations</h3>
     <div>
        <a href="http://tabbervilla.com/wordpress-post-tabs-pro/" title="Premium WordPress Tabs Plugin" target="_blank"><img src="<?php echo pointelle_slider_plugin_url('images/tabbervilla_980.png');?>" alt="Premium WordPress Tabs Plugin" style="width:100%;max-width:980px;"/></a>
     </div>
