...
class TTShowcase_Layers_Extension {
...
function layers_ttshowcase_extension_init() {
	global $ttshowcase_layers_extension;
	$ttshowcase_layers_extension = TTShowcase_Layers_Extension::get_instance();
}

add_action( 'plugins_loaded', 'layers_ttshowcase_extension_init' );